...
// Check for administrator rights (Owner only)
if ($auth->getRank() < 6) {
...
<div class="container-fluid">
    ...
    <!-- The remaining rows are the same, but with colored headers -->
    <div class="row">
